...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/DBConnect.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">DBConnect</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="DBConnect.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="DBConnect.asmx?op=HelloWorld">HelloWorld</a>
              ...
              <li>
                <a href="DBConnect.asmx?op=Listar">Listar</a>
